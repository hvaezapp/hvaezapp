...
|------------|-------------|
| [DigitalWallet](https://github.com/hvaezapp/DigitalWallet) | The User Wallet Service is developed using ASP.NET Core 9 and follows the Vertical Slice Architecture (VSA) principle. |
...
| [Basket](https://github.com/hvaezapp/Basket) | Basket service for an e-commerce platform in ASP.NET Core 9 with involves several key functionalities. |
